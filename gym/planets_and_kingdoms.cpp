...
#define ll long long
using namespace std;
// Get-Content t.txt | .\planets_and_kingdoms.exe

// construct scc
// crutch on scc to do everything, output scc.scc_count (num of components)
// then just ouput comp[i] + 1 for all i (which component node i belongs to)
